...
import { OwnUserDto } from '../models/own-user-dto';
...
export class UserControllerService extends BaseService {
   ...
   */
  static readonly GetOwnProfilePath = '/users/me';
  ...
  getOwnProfile$Response(params?: {
  }): Observable<StrictHttpResponse<OwnUserDto>> {

    const rb = new RequestBuilder(this.rootUrl, UserControllerService.GetOwnProfilePath, 'get');
    if (params) {
    }
    ...
    return this.http.request(rb.build({
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<OwnUserDto>;
      })
    );
  }
  ...
  }): Observable<OwnUserDto> {

    return this.getOwnProfile$Response(params).pipe(
      map((r: StrictHttpResponse<OwnUserDto>) => r.body as OwnUserDto)
    );
  }
